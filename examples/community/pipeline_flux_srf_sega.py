...
class FluxSemanticGuidancePipeline(DiffusionPipeline, FluxLoraLoaderMixin):
    r"""
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                ## Update using one step of SRF Solver by Rout et al.: https://rf-inversion.github.io/
                #latents = self.scheduler.SRFSolverStep(noise_pred, t, latents, return_dict=False)[0]
