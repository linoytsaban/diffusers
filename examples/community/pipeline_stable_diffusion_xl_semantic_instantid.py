...
class StableDiffusionXLSemanticInstantIDPipeline(StableDiffusionXLControlNetPipeline):
    ...
    def __call__(
        ...
        # sega/ledits editions
        edit_concepts_embeds: Optional[torch.FloatTensor] = None,
        edit_concepts_negative_prompt_embeds: Optional[torch.FloatTensor] = None,
        edit_concepts_pooled_prompt_embeds: Optional[torch.FloatTensor] = None,
        edit_concepts_negative_pooled_prompt_embeds: Optional[torch.FloatTensor] = None,
