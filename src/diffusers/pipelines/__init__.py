...
try:
    ...
    _import_structure["flux2"] = ["Flux2Pipeline", "Flux2KleinPipeline", "Flux2KleinInpaintPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .flux2 import Flux2KleinPipeline, Flux2Pipeline, Flux2KleinInpaintPipeline
